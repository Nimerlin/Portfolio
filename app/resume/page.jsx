 ...
 return (
  ...
  <div className="flex text-lg flex-col px-8 justify-center text-white rounded-3xl">
   ...
   <div className="flex items-center mt-4">
    ...
    <GiHandBag className="mr-2 text-2xl" />
     ...
     <div className="flex flex-col">
      ...
      <div className="flex items-center mb-2 relative">
       ...
       <div className="w-3/4 bg-gray-300 h-6 rounded-full relative">
        ...
        <div className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% h-full rounded-full w-1/2 relative">
      ...
      <div className="flex items-center mb-2 relative">
       ...
       <div className="w-3/4 bg-gray-300 h-6 rounded-full relative">
        ...
        <div className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% h-full rounded-full w-2/3 relative">
      ...
      <div className="flex items-center mb-2 relative">
       ...
       <div className="w-3/4 bg-gray-300 h-6 rounded-full relative">
        ...
        <div className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% h-full rounded-full w-full relative">
