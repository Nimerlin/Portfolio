...
const Sidenavbar = () => {
  ...
  <nav className="flex flex-col rounded-lg top-0 left-0 h-auto w-28 justify-between bg-black text-white ">
    <div className="flex flex-col justify-center px-6 py-6 items-center">
      <Link href="home/about" className="my-4 flex flex-col justify-center rounded-lg p-5 bg-gray-500 items-center hover:text-blue-500">
      ...
      <Link href="home/blog" className="my-4 flex flex-col justify-center rounded-lg p-5 bg-gray-500 items-center hover:text-blue-500">
      <LuBookOpen className=" size-14 "/>
      </Link>
      <Link href="home/portfolio" className="my-4 flex flex-col justify-center rounded-lg p-5 bg-gray-500 items-center hover:text-blue-500">
        <LuCodesandbox className=" size-14 "/>
      </Link>
      <Link href="home/contact" className="my-4 flex flex-col justify-center rounded-lg p-5 bg-gray-500 items-center hover:text-blue-500">
